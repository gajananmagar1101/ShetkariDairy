...
export function Logo({ size = 40, className = '' }: LogoProps) {
  return (
    <svg
      ...
      className={className}
    >
      <rect x="56" y="56" width="400" height="400" rx={90} fill="#5F259F" />
      <g transform="translate(147.50,386.20) scale(0.28,-0.28)" fill="white" stroke="white" strokeWidth="70" strokeLinejoin="round">
