          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              <input 
                ...
                onChange={(e) => setAutoGenIsRange(e.target.checked)}
            ...
            {autoGenError && (
              <div className="bg-rose-50/50 text-rose-600 dark:bg-rose-500/10 dark:text-rose-400 p-3 rounded-xl text-sm font-medium flex items-start gap-2 border border-rose-100 dark:border-rose-500/20">
